...
bool Humanoid::ekf_over_threshold()
{
...
void Humanoid::failsafe_ekf_event()
{
    ...
    if (!humanoid.flightmode->requires_GPS() && (g.fs_ekf_action != FS_EKF_ACTION_LAND_EVEN_MANUAL)) {
        return;
    }
...
void Humanoid::failsafe_ekf_off_event(void)
{
