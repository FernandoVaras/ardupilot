...
#pragma once
/*
  This is the main Humanoid class
 */
...
#include "RC_Channel_Humanoid.h"         // RC Channel Library

#include "GCS_MAVLink_Humanoid.h"
#include "GCS_Humanoid.h"
#include "AP_Arming_Humanoid.h"
...
class Humanoid : public AP_Vehicle
{
public:
    friend class GCS_MAVLINK_Humanoid;
    friend class GCS_Humanoid;
    friend class Parameters;
    friend class ParametersG2;

    friend class AP_Arming_Humanoid;
    friend class RC_Channel_Humanoid;
    friend class RC_Channels_Humanoid;
...
private:
    ...
    // GCS selection
    GCS_Humanoid _gcs; // avoid using this; use gcs()
    GCS_Humanoid &gcs()
    {
        return _gcs;
    }
    ...
    AP_BattMonitor battery{MASK_LOG_CURRENT,
                       FUNCTOR_BIND_MEMBER(&Humanoid::handle_battery_failsafe, void, const char*, const int8_t),
