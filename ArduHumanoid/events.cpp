...
bool Humanoid::failsafe_option(FailsafeOption opt) const
{
    return (g2.fs_options & (uint32_t)opt);
}

void Humanoid::failsafe_radio_on_event()
{
...
void Humanoid::failsafe_radio_off_event()
{
...
void Humanoid::handle_battery_failsafe(const char *type_str, const int8_t action)
{
...
void Humanoid::failsafe_gcs_check()
{
...
bool Humanoid::should_disarm_on_failsafe()
{
...
void Humanoid::do_failsafe_action(Failsafe_Action action, ModeReason reason)
{
