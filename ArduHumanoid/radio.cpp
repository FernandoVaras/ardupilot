...
void Humanoid::default_dead_zones()
{
...
void Humanoid::enable_motor_output()
{
    // enable motors
    motors->output_min();
}

void Humanoid::read_radio()
{
...
void Humanoid::set_throttle_and_failsafe(uint16_t throttle_pwm)
{
...
void Humanoid::set_throttle_zero_flag(int16_t throttle_control)
{
