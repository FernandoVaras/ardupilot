...
class GCS_Humanoid : public GCS
{
    friend class Humanoid; // for access to _chan in parameter declarations
...
public:
    ...
    GCS_MAVLINK_CHAN_METHOD_DEFINITIONS(GCS_MAVLINK_Humanoid);
...
protected:
    ...
    GCS_MAVLINK_Humanoid *new_gcs_mavlink_backend(AP_HAL::UARTDriver &uart) override
    {
        return NEW_NOTHROW GCS_MAVLINK_Humanoid(uart);
    }
