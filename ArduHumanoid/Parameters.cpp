...
/*
 *  Humanoid parameter definitions
 *
 */

#define DEFAULT_FRAME_CLASS 0

const AP_Param::Info Humanoid::var_info[] = {
    ...
    GOBJECT(arming,                 "ARMING_", AP_Arming_Humanoid),
    ...
    // @Description: Simple mode for Position control - "forward" moves humanoid in +ve X direction world-frame
    // @Values: 0:Disabled, 1:Enabled
    // @User: Standard
    ...
    // @Description: Output 0 thrust signal when humanoid is within this distance (in meters) of the target position. Warning: If this param is greater than MAX_POS_XY param then the humanoid won't move at all in the XY plane in Loiter mode as it does not allow more than a second's lag. Same for the other axes.
    // @Units: m
    // @Range: 0.1 1
    // @User: Standard
    ...
    // @Group: JOINTS_
    // @Path: Joints.cpp
    GOBJECTPTR(motors, "JOINTS_", Joints),
...
const AP_Param::GroupInfo ParametersG2::var_info[] = {
    ...
    // @Description: Controls major frame class for humanoid.
    // @Values: 0:Finnedhumanoid
    // @User: Standard
    // @RebootRequired: True
    ...
    AP_SUBGROUPINFO(rc_channels, "RC", 17, ParametersG2, RC_Channels_Humanoid),
    ...
    // @User: Advanced
    AP_GROUPINFO("FS_OPTIONS", 36, ParametersG2, fs_options, (float)Humanoid::FailsafeOption::GCS_CONTINUE_IF_PILOT_CONTROL),
...
void Humanoid::load_parameters(void)
{
